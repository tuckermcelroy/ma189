...
\[
 ...
 \\ \mathbf{E} [x_{ip} ] \end{array} \right] = \mathbf{E} [ \underline{x}_i ].
\]
...
\[
 ...
 \\ n^{-1} \sum_{i=1}^n x_{ip} \end{array} \right] = n^{-1} \sum_{i=1}^n \underline{x}_{i}.
\]
