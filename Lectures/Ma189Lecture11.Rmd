...
![Romano-British Pottery](images/pottery.jpg)
...
- The testing results are listed below. As all $F$ statistics `r c(F1,F2,F3,F4,F5)` exceed the critical value `r qf(.99,df1=3,df2=22)`, we reject all the null hypotheses. 
