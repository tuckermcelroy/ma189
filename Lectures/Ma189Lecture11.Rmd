...
- The testing results are listed below. As all $F$ statistics exceed the critical value 4.82, we
reject all the null hypotheses.
...
n2 <- length(pot[pot$Kiln == 2,])
n3 <- length(pot[pot$Kiln == 3,])
n4 <- length(pot[pot$Kiln == 4,])
n5 <- length(pot[pot$Kiln == 5,])
nv <- c(n2,n3,n4,n5)
