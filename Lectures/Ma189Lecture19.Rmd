...
\]
- Principle component analysis aims to find the linear combination $y_j$ such that $\mbox{Var} [ y_j]$ is maximized.
...
\]
for the second principle component that maximizes
\[
...
## $j$th Principle Component

- For $j \geq 2$, select
\[
  \underline{e}_j = {[ e_{j1}, e_{j2}, \ldots, e_{jp}]}^{\prime}
\]
for the $j$th principle component that maximizes
\[
 \mbox{Var}[ y_j] = \underline{e}_j^{\prime} {\mathbf \Sigma} \underline{e}_j
\]
subject to
...
![The first principle component of a two-dimensional dataset](images/one_pc.png)
