...
- We can visualize the BH procedure as follows. First, we plot $p_j$ versus $j$ for $1 \leq j \lew m$. Then we draw a line through the origin with slope $\alpha/m$.
...
\[
 H_0 : \mu_1 = \mu_1^0, \ldots, \mu_{100} = \mu_{100}^0
 \quad \mbox{versus} \quad  H_a : \mu_1 \neq \mu_1^0, \, \mbox{OR} \ldots \mbox{OR}, \, \mu_{100} \neq \mu_{100}^0.
\] 
