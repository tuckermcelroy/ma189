...
- A symmetric $n \times n$ dimensional matrix ${\bf A}$ is **positive semi-definite** if $\underline{v}^{\prime} {\bf A} \underline{v} \geq 0$ for alllength $n$ vectors $\underline{v}$.  Compactly written ${\bf A} \geq 0$.
